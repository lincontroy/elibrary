        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Books</h5>
                    <router-link v-if="can('user-list')" :to="{ name: 'books.create' }" class="btn btn-primary btn-sm float-end">
                        Add New
                    </router-link>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tr v-for="post in books.data" :key="post.id">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    ...
                                    <a href="#" v-if="can('user-delete')" @click.prevent="deleteBook(post.id)"
                ...
                <div class="card-footer">
                    <Pagination :data="books" :limit="3"
                                @pagination-change-page="page => getBooks(page, search_id, search_title, search_global, orderColumn, orderDirection)"
                                class="mt-4"/>
                </div>
            </div>
        </div>
